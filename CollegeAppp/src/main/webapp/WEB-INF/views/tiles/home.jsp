...
<link href="<%=request.getContextPath()%>/resources/flexslider/flexslider.css" rel="stylesheet" />
<link href="<%=request.getContextPath()%>/resources/js/owl-carousel/owl.carousel.css" rel="stylesheet">
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/styles.css" />
<!-- Font Awesome -->
<link href="<%=request.getContextPath()%>/resources/font/css/font-awesome.min.css" rel="stylesheet">
</head>
  ...
  <div class="container">
    <nav class="navbar navbar-inverse" role="navigation">
      <div class="navbar-header">
        ...
        <a href="#" class="navbar-brand scroll-top logo  animated bounceInLeft"><b><i>Bideshi PanchPhoron</i></b></a> </div>
      <!--/.navbar-header-->
      <div id="main-nav" class="collapse navbar-collapse">
        <ul class="nav navbar-nav" id="mainNav">
          <li class="active" id="firstLink"><a href="#home" class="scroll-link">Home</a></li>
          <li><a href="#services" class="scroll-link">Menu</a></li>
...
<section id="home">
  ...
  <!-- Slider -->
        <div id="main-slider" class="flexslider">
            <ul class="slides">
              <li>
                <img src="<%=request.getContextPath()%>/resources/images/slides/1.jpg" alt="" />
                <div class="flex-caption">
                    <h3>Awarded Restaurant</h3>  
                </div>
              </li>
              <li>
                <img src="<%=request.getContextPath()%>/resources/images/slides/2.jpg" alt="" />
                <div class="flex-caption">
                    <h3>Variety of foods</h3>   
                </div>
              </li>
              <li>
                <img src="<%=request.getContextPath()%>/resources/images/slides/3.jpg" alt="" />
                <div class="flex-caption">
...
<section id="services" class="page-section colord">
  <div class="container">
    <div class="row"> 
      <!-- item -->
      <div class="col-md-3 text-center"> <i class="circle"><img src="<%=request.getContextPath()%>/resources/images/1.png" alt="" /></i>
        <h3>Breakfast</h3>
      ...
      <!-- item -->
      <div class="col-md-3 text-center"><i class="circle"> <img src="<%=request.getContextPath()%>/resources/images/2.png" alt="" /></i>
        <h3>Lunch</h3>
        <p>Nullam ac rhoncus sapien, non gravida purus. Alinon elit imperdiet congue. Integer elit imperdiet congue.</p>
      </div>
      <!-- end: --> 
      ...
      <!-- item -->
      <div class="col-md-3 text-center"><i class="circle"> <img src="<%=request.getContextPath()%>/resources/images/3.png" alt="" /></i>
        <h3>Buffet</h3>
      ...
      <!-- item -->
      <div class="col-md-3 text-center"><i class="circle"> <img src="<%=request.getContextPath()%>/resources/images/4.png" alt="" /></i>
        <h3>Party</h3>
  ...
  <div class="container">
    ...
    <div class="row feature design">
      <div class="area1 columns right">
        <h3>labitur scsstie percipitoleat fabulas.</h3>
      ...
      <div class="area2 columns feature-media left"> <img src="<%=request.getContextPath()%>/resources/images/feature-img-1.png" alt="" width="100%"> </div>
    </div>
    <div class="row dataTxt">	
						<div class="col-md-8 col-sm-6">
							<h4>Our Services</h4>
							<p>Lorem ipsum dolor consectetursit amet, consectetur adipiscing elit consectetur euismod </p>
                            <p>Lorem ipsum dolor sit amet, ea eum labitur scsstie percipitoleat fabulas complectitur deterruisset at pro. Odio quaeque reformidans est eu, expetendis Odio quaeque reformidans est eu, expetendis intellegebat has ut, viderer invenire ut his. Has molestie percipit an. Falli volumus efficiantur sed id, ad vel noster propriae. Ius ut etiam vivendo, graeci iudicabit constituto at mea.</p>
							  <p>Lorem ipsum dolor sit amet, ea eum labitur scsstie percipitoleat fabulas complectitur deterruisset at pro. Odio quaeque reformidans est eu, expetendis intellegebat has ut, viderer invenire ut his. Has molestie percipit an. Falli volumus efficiantur sed id, ad vel noster propriae. Ius ut etiam vivendo, graeci iudicabit constituto at mea.</p>
                ...
                <div class="carousel-inner">
                    <div class="item active">
                	    <div class="col-md-4 col-sm-6">
        				    <div class="block-text rel zmin">
						        ...
						        <p>Lorem ipsum dolor sit amet, ea eum labitur scsstie percipitoleat fabulas complectitur deterruisset at pro. Odio quaeque reformidans est eu, expetendis intellegebat has ut, viderer invenire ut his. Has molestie percipit an.</p>
            			...
            			<div class="col-md-4 col-sm-6 hidden-xs">
							...
							<div class="person-text rel">
				                <img src="<%=request.getContextPath()%>/resources/images/12.png"/>
						...
						<div class="col-md-4 col-sm-6 hidden-sm hidden-xs">
							...
							<div class="person-text rel">
								<img src="<%=request.getContextPath()%>/resources/images/13.png"/>
                    ...
                    <div class="item">
                        <div class="col-md-4 col-sm-6">
							...
							<div class="person-text rel">
								<img alt="" src="<%=request.getContextPath()%>/resources/images/12.png">
								<a title="" href="#">Anna</a>
								<i>from Glasgow, Scotland</i>
							</div>
						</div>
            			<div class="col-md-4 col-sm-6 hidden-xs">
							...
							<div class="person-text rel">
								<img alt="" src="<%=request.getContextPath()%>/resources/images/13.png">
						        <a title="" href="#">Ella Mentree</a>
								<i>United States</i>
							</div>
						</div>
						<div class="col-md-4 col-sm-6 hidden-sm hidden-xs">
							...
							<div class="person-text rel">
								<img alt="" src="<%=request.getContextPath()%>/resources/images/11.png">
								<a title="" href="#">Rannynm</a>
								<i>Indonesia</i>
							</div>
						</div>
      ...
      <div class="col-md-12">
        <div id="portfolio">
          ...
          <ul class="items list-unstyled clearfix animated fadeInRight showing" data-animation="fadeInRight" style="position: relative; height: 438px;">
            <li class="item branding" style="position: absolute; left: 0px; top: 0px;"> <a href="<%=request.getContextPath()%>/resources/images/work/1.jpg" class="fancybox"> <img src="<%=request.getContextPath()%>/resources/images/work/1.jpg" alt="">
              <div class="overlay"> <span>Etiam porta</span> </div>
              </a> </li>
            <li class="item photography" style="position: absolute; left: 292px; top: 0px;"> <a href="<%=request.getContextPath()%>/resources/images/work/2.jpg" class="fancybox"> <img src="<%=request.getContextPath()%>/resources/images/work/2.jpg" alt="">
              <div class="overlay"> <span>Lorem ipsum</span> </div>
              </a> </li>
            <li class="item branding" style="position: absolute; left: 585px; top: 0px;"> <a href="<%=request.getContextPath()%>/resources/images/work/3.jpg" class="fancybox"> <img src="<%=request.getContextPath()%>/resources/images/work/3.jpg" alt="">
              <div class="overlay"> <span>Vivamus quis</span> </div>
              </a> </li>
            <li class="item photography" style="position: absolute; left: 877px; top: 0px;"> <a href="<%=request.getContextPath()%>/resources/images/work/4.jpg" class="fancybox"> <img src="<%=request.getContextPath()%>/resources/images/work/4.jpg" alt="">
              <div class="overlay"> <span>Donec ac tellus</span> </div>
              </a> </li>
            <li class="item photography" style="position: absolute; left: 0px; top: 219px;"> <a href="<%=request.getContextPath()%>/resources/images/work/5.jpg" class="fancybox"> <img src="<%=request.getContextPath()%>/resources/images/work/5.jpg" alt="">
              <div class="overlay"> <span>Etiam volutpat</span> </div>
              </a> </li>
            <li class="item web" style="position: absolute; left: 292px; top: 219px;"> <a href="<%=request.getContextPath()%>/resources/images/work/6.jpg" class="fancybox"> <img src="<%=request.getContextPath()%>/resources/images/work/6.jpg" alt="">
              <div class="overlay"> <span>Donec congue </span> </div>
              </a> </li>
            <li class="item photography" style="position: absolute; left: 585px; top: 219px;"> <a href="<%=request.getContextPath()%>/resources/images/work/7.jpg" class="fancybox"> <img src="<%=request.getContextPath()%>/resources/images/work/7.jpg" alt="">
              <div class="overlay"> <span>Nullam a ullamcorper diam</span> </div>
              </a> </li>
            <li class="item web" style="position: absolute; left: 877px; top: 219px;"> <a href="<%=request.getContextPath()%>/resources/images/work/8.jpg" class="fancybox"> <img src="<%=request.getContextPath()%>/resources/images/work/8.jpg" alt="">
...
<section id="team" class="page-section">
      ...
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-6"> 
          ...
          <div class="team-member pDark"> 
            ...
            <div class="member-img"> 
              <!-- Image  --> 
              <img class="img-responsive" src="<%=request.getContextPath()%>/resources/images/photo-1.jpg" alt=""> </div>
            <!-- Member Details -->
            <h4>John Doe</h4>
            <!-- Designation --> 
        ...
        <div class="col-md-3 col-sm-6 col-xs-6"> 
          ...
          <div class="team-member pDark"> 
            ...
            <div class="member-img"> 
              <!-- Image  --> 
              <img class="img-responsive" src="<%=request.getContextPath()%>/resources/images/photo-2.jpg" alt=""> </div>
            <!-- Member Details -->
            <h4>Larry Doe</h4>
            <!-- Designation --> 
        ...
        <div class="col-md-3 col-sm-6 col-xs-6"> 
          ...
          <div class="team-member pDark"> 
            ...
            <div class="member-img"> 
              <!-- Image  --> 
              <img class="img-responsive" src="<%=request.getContextPath()%>/resources/images/photo-3.jpg" alt=""> </div>
            <!-- Member Details -->
            <h4>Ranith Kays</h4>
            <!-- Designation --> 
            <span class="pos">Senior Chef</span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-6"> 
          ...
          <div class="team-member pDark"> 
            ...
            <div class="member-img"> 
              <!-- Image  --> 
              <img class="img-responsive" src="<%=request.getContextPath()%>/resources/images/photo-4.jpg" alt=""> </div>
            <!-- Member Details -->
            <h4>Joan Ray</h4>
            <!-- Designation --> 
  ...
  <section id="map">
      ...
      <p class="map-error">Something went wrong... Unable to load map.</p>
